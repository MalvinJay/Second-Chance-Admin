...
const AddPreviousShowsPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-500 flex flex-col font-plusjakartasans items-center justify-end mx-auto p-[110px] md:px-10 sm:px-5 w-full">
...
export default AddPreviousShowsPage;
