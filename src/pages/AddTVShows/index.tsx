  ...
  return (
    <>
      <div className="bg-gray-500 flex flex-col font-plusjakartasans items-center justify-start mx-auto p-16 md:px-10 sm:px-5 w-full">
        <div className="bg-white-A700 flex flex-col items-center justify-end max-w-[1049px] mb-[39px] mx-auto p-6 md:px-5 rounded-[10px] shadow-bs w-full">
