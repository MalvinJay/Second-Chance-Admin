        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar className="!sticky !w-[193px] bg-gray-900 flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]">
            ...
            <Menu
              ...
              className="flex flex-col items-center justify-start mb-[2078px] mt-[63px] pr-3.5 w-[93%]"
            >
                  ...
                  >
                    <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                      ...
                      <Text
                        ...
                        size="txtPlusJakartaSansRomanRegular12Bluegray900"
                      >
                        Lorem ipsum dolor sit amet consectetur. In morbi
                        senectus.
                      </Text>
                      <Text
                        ...
                        <div className="flex flex-col gap-4 items-center justify-start w-auto">
                          ...
                          <div className="flex flex-col gap-2 items-center justify-start w-auto">
                            ...
                            <Text
                              ...
                              size="txtPlusJakartaSansRomanRegular12"
                            >
                              Lorem ipsum dolor sit amet consectetur. Turpis mi
                              ut bibendum vitae intege
                            </Text>
                          </div>
                        </div>
                        <Button
